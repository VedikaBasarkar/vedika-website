    ...
    <div>
    {
      ...
      <nav className="z-30 bg-primary-700">
        <div className="max-w-screen-xl flex flex-row items-center justify-between mx-auto p-10">
          ...
          <a name="About page" href="/about" className='tracking-wider font-semibold text-white hover:text-cyan-600'>Drop me an e-mail</a>
        </div>
      </nav>
      ...
      <nav className="z-30 bg-white">
        <div className="max-w-screen-xl flex flex-row items-center justify-between mx-auto p-10">
          ...
          <a name="About page" href="/about" className='tracking-wider font-semibold hover:text-cyan-600'>ABOUT</a>
        </div>
      </nav>
