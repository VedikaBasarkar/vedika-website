  ...
  return (
    ...
    <ProgressBar progressColor={'#EF3939'} />
          ...
          <div className='project-section-heading'>Introduction</div>              
            <div className=' flex flex-row flex-wrap'>
              ...
              <div className='w-full md:w-2/3 md:pl-4'>
                ...
                <p className='mb-5'>Theme for this competition was <span className='text-ripple font-semibold'>Design of Digital Wellness by providing digital solution</span>. Challenge brief was:</p>
        ...
        <div className='project-section'>
          ...
          <p>To understand the brief and to come up with a solution in limited time, we preferred to follow the double diamond method.</p>
          <p>But during <span className='text-ripple font-semibold'>finalising the concept, we again had to do research</span> so mostly we followed double diamond with a little back and forth of domain research.</p>
        ...
        <div className='project-section'>
          ...
          <div className='flex flex-row flex-wrap'>
            ...
            <div className='w-full md:w-2/3 md:pl-4 flex flex-col justify-center'>
              ...
              <p className='mb-5'>• Mental well-being - State that enables people to cope with the stress of life, realize their abilities, learn & work well, and contribute to the community.</p>
          ...
          <div className='flex flex-row flex-wrap mt-10 md:mt-20'>
            ...
            <div className='w-full md:w-2/3 md:pl-4 flex flex-col justify-center'>
              <p className='mb-5'>Google trends for "Social media" shows that the interest in social media has increased considerably over time and is still on a rise.</p>
              ...
              <p className='my-5'>Google trends for "Digital wellbeing" shows that the interest in Digital wellbeing has boomed suddenly in the past few years and it seems to stay due to increasing awareness.</p>
          ...
          <div className='flex flex-row flex-wrap mt-10 md:mt-20'>
            ...
            <div className='w-full md:w-2/3 md:pl-4 flex flex-col justify-center'>
              ...
              <p className='mt-8 mb-4'>This is a huge number of users who are mutually included for using different social media platforms. Following are some big social media platforms which have a big number of active users. </p>
            ...
            <div className='w-full md:w-1/3 md:pr-4 mt-10 md:mt-20'>
              <div className='project-section-subheading'>Looking into the numbers <br /><span className='text-ripple'> for a relation with digital wellness</span></div>
            ...
            <div className='w-full md:w-2/3 md:pl-4 flex flex-col justify-center mt-10 md:mt-20'>
              ...
              <p>Questions were : </p>
              <p><span className='text-ripple font-semibold'>Are we in Control of social media? <br />What is the reason behind people spending lot of time on it? <br />If people are aware of overusage then are they doing something about it?</span></p>
            </div>
          ...
          <div className='flex flex-row flex-wrap mt-10 md:mt-20'>
            ...
            <div className='w-full md:w-2/3 md:pl-4 flex flex-row flex-wrap'>
              <div className='w-full md:w-1/2 pr-2 pb-4'>
                <div className='bg-ripple text-white p-4 rounded-md shadow-lg'>People in general are aware of the issues of overconsumption of media but still can’t control the urges.</div>
              </div>
              <div className='w-full md:w-1/2 pr-2 pb-4'>
                <div className='bg-ripple text-white p-4 rounded-md shadow-lg'>Many undergraduate students experience phantom vibrations or feeling of getting notifications.</div>
              </div>
              <div className='w-full md:w-1/2 pr-2 pb-4'>
                <div className='bg-ripple text-white p-4 rounded-md shadow-lg'>Notifications come across as a major distraction element.</div>
              </div>
              <div className='w-full md:w-1/2 pr-2 pb-4'>
                <div className='bg-ripple text-white p-4 rounded-md shadow-lg'>Overuse of social media also affects their physical health, like obesity, backpain, etc.</div>
              </div>
              <div className='w-full md:w-1/2 pr-2 pb-4'>
                <div className='bg-ripple text-white p-4 rounded-md shadow-lg'>Lot of people complain about mental health issues and lack of free time due to social media.</div>
              </div>
              <div className='w-full md:w-1/2 pr-2 pb-4'>
              ...
              <div className='w-full md:w-1/2 pr-2 pb-4'>
                <div className='bg-ripple text-white p-4 rounded-md shadow-lg'>Although lot of companies are targeting mental wellbeing, they don’t implement hard features, possibly due to its negative impact on their usage and sales.</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='project-section'>
          ...
          <div className='flex flex-row flex-wrap mt-10 md:mt-20'>
            ...
            <div className='w-full md:w-2/3 md:pl-4 flex flex-col justify-center'>
              <p className='mb-5'>1. None of the applications work across devices and are only limited to phones. Considering people are seeking rehab from their phone, it could be a great missed opportunity.</p>
              <p className='mb-5'>2. Most of the apps rely on forcefully making people not use their phones or showing them stats so that they stop using them. This often leads to more guilt.</p>
        ...
        <div className='project-section'>
          ...
          <div className='flex flex-row flex-wrap mt-10 md:mt-20'>
            ...
            <div className='w-full md:w-2/3 md:pl-4 flex flex-col justify-center'>
              <p className='mb-5'>A survey was conducted to validate the secondary research and to also check the user behaviour between ages 18-65. There were patterns observed in social media usage.</p>
              ...
              <div className='flex flex-row flex-wrap'>
                <div className='w-full mb-10'>
                    <p className='mb-3'>There were various ill effects stated during this survey. Some of those are listed below: </p>
        ...
        <div className='project-section'>
            ...
            <div className='w-full md:w-2/3 md:pl-4 flex flex-col justify-center'>
              ...
              <div className='flex flex-row flex-wrap'>
                <div className='w-full lg:w-1/2 lg:pr-4'>
                  ...
                  <p>• Children start throwing tantrums and become more impatient because of continuous use.</p>
                  <p>• Job demands working on mobile. Children see and start immitating.</p>
                </div>
                <div className='w-full lg:w-1/2 lg:pl-4'>
                  <b>Goals</b>
                  <p>• Reduce screen time of children.</p>
                  <p>• Take care of children’s physical as well as mental health.</p>
            ...
            <div className='w-full md:w-2/3 md:pl-4 flex flex-col justify-center'>
              ...
              <div className='flex flex-row flex-wrap'>
                ...
                <div className='w-full lg:w-1/2 lg:pl-4'>
                  ...
                  <p>• To tackle the continuous distraction by notifications.</p>
          ...
          <div className='flex flex-row flex-wrap mt-10 md:mt-20'>
            ...
            <div className='w-full md:w-2/3 md:pl-4 flex flex-col justify-center'>
              ...
              <div className='flex flex-row flex-wrap'>
                <div className='w-full lg:w-1/2 lg:pr-4'>
                  <b>Pain points</b>
                  <p>• I have to use my mobile for work purposes, which strains my eyes and head after some time.</p>
                  <p>• Other than work, I get many notifications from social media platforms, which takes up a lot of time.</p>
          ...
          <div className='flex flex-row flex-wrap mt-10 md:mt-20'>
            ...
            <div className='w-full md:w-2/3 md:pl-4 flex flex-col justify-center'>
              <p>Following is a scenario for one of the personae</p>
        ...
        <div className='project-section'>
          ...
          <div className='flex flex-row flex-wrap mt-10 md:mt-20'>
            ...
            <div className='w-full md:w-2/3 md:pl-4 flex flex-row flex-wrap'>
              <p className='ripple-keywords'>Excessive screen time creating an imbalance in personal and professional life</p>
              ...
              <p className='ripple-keywords'>Even without notification, users check their phones looking for missed notifications</p>
        ...
        <div className='project-section'>
          ...
          <div className='flex flex-row flex-wrap mt-10 md:mt-20'>
            ...
            <div className='w-full md:w-2/3 md:pl-4 flex flex-row flex-wrap'>
              <p className='project-section-small-heading'>Designing a means to allow users to indulge in tech, rehabilitate from their addiction to social media by cutting them out of the notification dopamine reward cycle in order to lead a healthier lifestyle.</p>
            </div>
          </div>
        ...
        <div className='project-section'>
          ...
          <div className='flex flex-row flex-wrap'>
            ...
            <div className='w-full md:w-2/3 md:pl-4 flex flex-row flex-wrap'>
              <p className='my-5'>What else are people carrying that might help in reducing screen time?</p>
        ...
        <div className='project-section'>
          ...
          <div className='flex flex-row flex-wrap-reverse '>
            ...
            <div className='w-full md:w-1/2 md:pl-4 flex flex-col justify-center'>
              <p className='project-section-subheading pb-10'>Designing an application to allow people using <span className='text-ripple'>Smart Wearables</span> to cut their addiction of social media by <span className='text-ripple'>cutting them out of the notification dopamine reward cycle</span> in order to lead a healthier lifestyle.</p>
            </div>
          </div>
        </div>
